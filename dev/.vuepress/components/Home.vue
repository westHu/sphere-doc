...
document.title = 'smilepay - ' + home.value.title;
</script>

<style>
.feature-container {
    @apply pt-20 mb-10 flex flex-col gap-y-20 overflow-hidden sm:pt-32 sm:mb-32 sm:gap-y-32 md:pt-20 md:mb-0 md:gap-y-40;
}
</style>